...
const styles = StyleSheet.create({
  ...
  showDetails: { marginLeft: spacing.md, justifyContent: 'center' },
  ...
  inviteText: { flex: 1, marginLeft: spacing.md },
  ...
  rankBadge: { ...typography.labelLarge, color: colors.accent.main, marginRight: spacing.md, width: 30 },
  topReviewerAvatar: { width: 44, height: 44, borderRadius: 22 },
  topReviewerInfo: { flex: 1, marginLeft: spacing.md },
