...
const styles = StyleSheet.create({
  ...
  showInfo: { flex: 1, marginStart: spacing.md, justifyContent: 'center' },
  ...
  checkbox: { width: 24, height: 24, borderRadius: 6, borderWidth: 2, borderColor: colors.dark[400], alignItems: 'center', justifyContent: 'center', marginEnd: spacing.md },
