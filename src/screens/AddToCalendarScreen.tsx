...
const styles = StyleSheet.create({
  ...
  calendarName: { flex: 1, ...typography.labelMedium, color: colors.neutral.textSecondary, marginLeft: spacing.md },
  ...
  previewColor: { width: 4, height: 40, borderRadius: 2, marginRight: spacing.md },
