...
const styles = StyleSheet.create({
  ...
  fontSizeThumb: { position: 'absolute', left: '50%', top: -8, width: 20, height: 20, borderRadius: 10, backgroundColor: colors.neutral.white, marginLeft: -10, shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.2, shadowRadius: 4, elevation: 3 },
