...
const styles = StyleSheet.create({
  ...
  galleryImage: { width: SCREEN_WIDTH * 0.7, height: 180, borderRadius: 12, marginRight: spacing.md },
  ...
  stageIcon: { width: 48, height: 48, borderRadius: 12, backgroundColor: 'rgba(168, 85, 247, 0.2)', alignItems: 'center', justifyContent: 'center', marginRight: spacing.md },
  stageInfo: { flex: 1 },
  ...
  accessibilityIcon: { width: 40, height: 40, borderRadius: 10, backgroundColor: 'rgba(16, 185, 129, 0.2)', alignItems: 'center', justifyContent: 'center', marginRight: spacing.md },
